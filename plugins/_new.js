let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `BONNIEE_KE-MD 𝐓𝐄𝐂𝐇 𝐎𝐅𝐅𝐈𝐂𝐀𝐋 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐂𝐇𝐀𝐍𝐍E𝐋𝐄 𝐅𝐎𝐋𝐋𝐎𝐖 𝐑𝐄𝐐_\n *𝐋𝐈𝐍𝐊*:https://whatsapp.com/channel/0029Vaj4B7YEFeXnAZYZIo0j\n\n ${Config.botname} *WORKS*`;
...
smd(
  ...
  async (message) => {
    const SupportMsg = `BONNIEE_KE-𝐌𝐃 𝐎𝐅𝐅𝐈𝐂𝐀𝐋 𝐒𝐔𝐏𝐏𝐎𝐑𝐓 𝐆𝐑𝐎𝐔𝐏\n\n *ʟɪɴᴋ:*https://chat.whatsapp.com/HRn1EEb7GikIkAb0IDqzRi\n\n ${Config.botname} *WORKS*`;
