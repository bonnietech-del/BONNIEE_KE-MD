...
`;
     ...
     try {
       ...
       if (!_0x1c586e) {
         return await _0x1ae8f8.reply(
           "*Provide Repo Url, _.https://github.com/BONNIEE_KE-MD/BONNIEE_KE_*"
         );
       }
       const _0x5906ab =
 ...
 smd({
   ...
   try {
     ...
     if (!_0x204f81) {
       return _0x55aba2.reply("*_Example : .tts Hi,I am BONNIEE_KE-Md whatsapp bot._*");
     }
     try {
 ...
 smd(
   ...
   async (m, url) => {
     try {
       ...
       const caption = `『 *BONNIEE_KE-ᴍᴅ Mᴇᴅɪᴀғɪʀᴇ Dᴏᴡɴʟᴏᴀᴅᴇʀ* 』\n\n *Name* : ${result.name}\n *Size* : ${result.size}\n *Mime* : ${result.mime}\n\n\n${Config.caption}`;
